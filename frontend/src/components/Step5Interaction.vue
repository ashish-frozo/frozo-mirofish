          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick conversational version of the report generation agent, with access to 4 professional tools and full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that can conduct parallel multi-turn conversations with simulated agents to collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean up <br> before opening paragraph tag immediately after block-level elements
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prefer reddit platform replies, fallback to twitter
