      ...
      - in: body
        ...
        schema:
          ...
          properties:
            ...
            graph_id:
              type: string
              description: Graph ID (optional, fetched from project if not provided)
            enable_twitter:
              type: boolean
              default: true
            enable_reddit:
          ...
          properties:
            ...
            data:
              ...
              properties:
                ...
                status: {type: string}
      400:
        description: Missing project_id or project not ready
      404:
...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    ...
    Note: Run scripts (run_*.py) remain in backend/scripts/ directory and are not copied to simulation directory
...
def _get_report_id_for_simulation(simulation_id: str) -> str:
    ...
    Scans the reports directory to find reports matching the simulation_id.
      ...
      - in: body
        ...
        schema:
          ...
          properties:
            ...
            max_rounds:
              type: integer
              description: Max simulation rounds
            enable_graph_memory_update:
              type: boolean
              default: false
              description: Update agent activity to knowledge graph in realtime
            force:
              type: boolean
              default: false
              description: Force restart (stops running simulation and cleans logs)
    responses:
      200:
      ...
      400:
        description: Missing simulation_id or simulation not ready
      404:
        ...
        schema:
          ...
          properties:
            ...
            data:
              ...
              properties:
                simulation_id: {type: string}
                runner_status: {type: string, enum: [idle, running, completed, failed, stopped]}
...
def get_run_status_detail(simulation_id: str):
    ...
    Used for frontend realtime feed display
...
def interview_agent():
    ...
    Note: This feature requires the simulation environment to be in running state (waiting for commands after completing simulation cycles)
    ...
    try:
        ...
        if not SimulationRunner.check_env_alive(simulation_id):
            return jsonify({
                "success": False,
                "error": "Simulation environment is not running or has been closed. Please ensure the simulation has completed and entered waiting-for-commands mode."
            }), 400
...
def interview_all_agents():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",            // Required, Simulation ID
            "prompt": "What is your overall opinion on this matter?",  // Required, interview question (same for all Agents)
...
def close_simulation_env():
    ...
    Send a close environment command to the simulation, allowing it to gracefully exit waiting-for-commands mode.
