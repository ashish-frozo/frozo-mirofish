...
document content, and graph information. Fully automated, no manual parameter setup needed.
...
# Global daily schedule configuration (UTC-based, adaptable to any timezone)
GLOBAL_TIMEZONE_CONFIG = {
    ...
    "activity_multipliers": {
        ...
        "morning": 0.4,    # Morning, gradually increasing activity
...
- The user group follows a general daily activity pattern
...
- General pattern: low activity at night, gradual increase in morning, moderate during work, evening peak
- **Important**: The example values below are for reference only. You should adjust specific time periods based on event nature and participant group characteristics.
  ...
  - Example: Breaking news may cause discussions even late at night, off_peak_hours can be shortened accordingly
    ...
    def _assign_initial_post_agents(
        ...
        for post in event_config.initial_posts:
            ...
            if matched_agent_id is None:
                logger.warning(f"No matching Agent found for type '{poster_type}', using most influential Agent")
                if agent_configs:
...
- **Schedule follows typical daily patterns**: midnight 0-5 AM almost no activity, evening 7-10 PM most active
...
{{
    "agent_configs": [
        {{
            ...
            "active_hours": [<list of active hours, following daily patterns>],
