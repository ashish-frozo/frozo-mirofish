...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, sends batches to Zep after accumulating BATCH_SIZE activities.

    All meaningful actions are updated to Zep. action_args contains complete context information:
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        - QUOTE_POST (quoting a post)
        - SEARCH_POSTS (searching posts)
        - SEARCH_USER (searching users)
        ...
        action_args contains complete context information (e.g., post content, usernames, etc.).
