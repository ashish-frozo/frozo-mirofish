...
**Acceptable**:
- Specific individuals (public figures, parties involved, opinion leaders, scholars/experts, ordinary people)
...
- Various people will appear in the text, such as "elementary school teachers", "random passerby", "some netizen"
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Limits: max 10 custom entity types, max 10 custom edge types
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
