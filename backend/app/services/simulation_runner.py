...
class SimulationRunner:
    ...
    def _terminate_process(cls, process: subprocess.Popen, simulation_id: str, timeout: int = 10):
        ...
        if IS_WINDOWS:
            ...
            # Since start_new_session=True is used, process group ID equals the main process PID
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                try:
                    ...
                    # Get platform: prefer the record's platform, otherwise use default platform
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this environment variable is absent, and registration is still needed
