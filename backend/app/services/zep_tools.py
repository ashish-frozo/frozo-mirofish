...
class ZepToolsService:
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes questions and searches multi-dimensionally:
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios that require understanding the full picture or tracking evolution.
    ...
    def interview_agents(
        ...
        1. Auto-reads profile files to learn about all simulated agents
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean potential tool call JSON wrapping
                ...
                # Strategy 2 (supplementary): Extract text within properly paired quotation marks
                if not key_quotes:
            ...
            result.summary = f"Interview failed: {str(e)}. The simulation environment may be shut down. Please ensure OASIS environment is running."
            return result
        except Exception as e:
