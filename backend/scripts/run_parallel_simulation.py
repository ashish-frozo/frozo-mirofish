...
def fetch_new_actions_from_db(
    ...
    Args:
        ...
        last_rowid: The max rowid from the last read (using rowid instead of created_at because different platforms have different created_at formats)
...
def create_model(config: Dict[str, Any], use_boost: bool = False):
    ...
    for different platforms, increasing concurrent capacity.
...
async def run_twitter_simulation(
    ...
    # If an agent is not in config, use OASIS's default name
    ...
    # Note: do not close environment, preserve for Interview use
...
def setup_signal_handlers(loop=None):
    ...
    Persistent simulation scenario: environment stays alive after simulation completes, waiting for interview commands.
